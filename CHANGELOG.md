...
- WordPress.org plugin directory assets (icon, banner) now served from the correct SVN directory path.
...
- Remove `.gitkeep` placeholder files that were incorrectly included in the release package (WordPress Plugin Check: `hidden_files` error).
